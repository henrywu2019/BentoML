...
from kappa.cli.aws_lambda import get_aws_lambda_sub_command
from kappa.cli.aws_sagemaker import get_aws_sagemaker_sub_command
from kappa.cli.azure_functions import get_azure_functions_sub_command
from kappa.cli.aws_ec2 import get_aws_ec2_sub_command
from kappa.cli.bento_management import add_bento_sub_command
...
from kappa.cli.deployment import get_deployment_sub_command


def create_kappa_cli():
...
if __name__ == "__main__":
    from kappa import commandline_interface
