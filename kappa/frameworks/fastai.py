...
def _import_fastai1_module():
    try:
        ...
        raise MissingDependencyException(
            "fastai package is required to use " "kappa.artifacts.FastaiModelArtifact"
        )
...
class Fastai1ModelArtifact(MyModelArtifact):
    ...
    >>> from kappa.frameworks.fastai import Fastai1ModelArtifact
    >>>
...
class FastaiModelArtifact(MyModelArtifact):
    ...
    >>> from kappa.adapters import FileAdapter
    >>>
