...
import kappa.gamma.proto.gamma_service_pb2 as gamma__service__pb2
...
class GammaStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetGammaServiceVersion = channel.unary_unary(
                '/kappa.Gamma/GetGammaServiceVersion',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
        ...
        self.DescribeDeployment = channel.unary_unary(
                '/kappa.Gamma/DescribeDeployment',
        ...
        self.DangerouslyDeleteBento = channel.unary_unary(
                '/kappa.Gamma/DangerouslyDeleteBento',
...
def add_GammaServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'kappa.Gamma', rpc_method_handlers)
...
class Gamma(object):
    ...
    def HealthCheck(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/HealthCheck',
    ...
    def GetGammaServiceVersion(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/GetGammaServiceVersion',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
    ...
    def ApplyDeployment(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/ApplyDeployment',
    ...
    def DeleteDeployment(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/DeleteDeployment',
    ...
    def GetDeployment(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/GetDeployment',
    ...
    def DescribeDeployment(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/DescribeDeployment',
    ...
    def ListDeployments(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/ListDeployments',
    ...
    def AddBento(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/AddBento',
    ...
    def UpdateBento(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/UpdateBento',
    ...
    def GetBento(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/GetBento',
    ...
    def DangerouslyDeleteBento(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/DangerouslyDeleteBento',
    ...
    def ContainerizeBento(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/kappa.Gamma/ContainerizeBento',
