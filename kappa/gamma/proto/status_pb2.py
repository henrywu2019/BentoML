...
_STATUS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status_code', full_name='kappa.Status.status_code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='error_message', full_name='kappa.Status.error_message', index=1,
...
Status = _reflection.GeneratedProtocolMessageType('Status', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:kappa.Status)
  })
