...
from kappa.gamma.proto.deployment_pb2 import DeploymentSpec
...
def get_deployment_operator(gamma_service, deployment_pb):
    ...
    if operator == DeploymentSpec.AWS_SAGEMAKER:
        ...
        from kappa.gamma.deployment.azure_functions.operator import (
        ...
        from kappa.gamma.deployment.aws_ec2.operator import AwsEc2DeploymentOperator
