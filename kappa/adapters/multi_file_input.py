...
from kappa.adapters.base_input import BaseInputAdapter, parse_cli_inputs
from kappa.adapters.utils import decompress_gzip_request
from kappa.types import AwsLambdaEvent, FileLike, HTTPRequest, InferenceTask
...
class MultiFileInput(BaseInputAdapter):
    ...
    .. code-block:: python
        ...
        import numpy as np
        import kappa
        from kappa.types import FileLike
        from kappa.framework.pytroch import PytorchModelArtifact
