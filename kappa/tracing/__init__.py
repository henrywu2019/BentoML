...
def get_tracer(
    ...
    # TODO: remove this check after PR1543 https://github.com/kappa/Kappa/pull/1543
    ...
    if tracer_type and tracer_type.lower() == 'zipkin' and zipkin_server_url:
        from kappa.tracing.zipkin import get_zipkin_tracer
        ...
        from kappa.tracing.jaeger import get_jaeger_tracer
        ...
        from kappa.tracing.noop import NoopTracer
