...
def create_oci_bucket_if_not_exists(bucket_name, region):
    ...
    try:
        ...
        object_storage_client = oci.object_storage.ObjectStorageClient(config)
        namespace = object_storage_client.get_namespace().data
        bucket_info = object_storage_client.get_bucket(
        ...
        try:
            create_bucket_response = object_storage_client.create_bucket(
                ...
                oci.object_storage.models.CreateBucketDetails(
                    name=bucket_name, public_access_type='ObjectRead',
                ),
            )
        except oci.exceptions.ServiceError as error:
...
if __name__ == "__main__":
    ...
    fileobj = io.BytesIO()
    download_oos_to_file(
        "oci://henry_test/kappa/IrisClassifier/20210527183535_867846.tar.gz", fileobj
    )
