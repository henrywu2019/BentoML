...
TRACK_CLI_EVENT_NAME = 'kappa-cli'
...
class KappaCommandGroup(click.Group):
    ...
    def kappa_common_params(func):
        ...
        def wrapper(quiet, verbose, *args, **kwargs):
            if quiet:
                ...
                if verbose:
                    logger.warning(
                        "The kappa command option `--verbose/--debug` is ignored when"
    ...
    @staticmethod
    def kappa_track_usage(func, cmd_group, **kwargs):
