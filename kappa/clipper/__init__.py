...
from kappa.saved_bundle import load_bento_service_api
...
RUN if [ -f /container/kappa-init.sh ]; then bash -c /container/kappa-init.sh; fi
...
def deploy_kappa(
    ...
    """Deploy kappa bundle to clipper cluster
