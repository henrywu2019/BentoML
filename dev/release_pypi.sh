...
# Currently only Kappa maintainer has permission to create new pypi
# releases
...
if git rev-parse "$tag_name" >/dev/null 2>&1; then
  ...
  git tag -a "$tag_name" -m "Tag generated by Kappa/script/release.sh, version: $VERSION_STR"
...
echo "Done releasing Kappa version:$VERSION_STR"
