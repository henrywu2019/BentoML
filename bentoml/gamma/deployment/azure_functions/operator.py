...
from bentoml.gamma.deployment.azure_functions.templates import AZURE_API_FUNCTION_JSON
from bentoml.gamma.deployment.operator import DeploymentOperatorBase
...
from bentoml.gamma.proto.repository_pb2 import GetBentoRequest
