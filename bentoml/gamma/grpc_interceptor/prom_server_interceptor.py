...
import grpc
from bentoml.gamma.metrics import (
...
from bentoml.gamma.utils import (
    get_method_type,
    parse_method_name,
...
class PromServerInterceptor(grpc.ServerInterceptor):  # pylint: disable=W0232
    ...
    Refers to
    tests/gamma/grpc_testing_service.py for a mock gRPC service
    tests/gamma/client/test_grpc_server_interceptor.py for an implementation's example

    ```python

        import grpc
        from prometheus_client import start_http_server
        from bentoml.gamma.client.interceptor import PromServerInterceptor
        ...
        server = grpc.server(
