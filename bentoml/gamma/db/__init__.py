...
from bentoml.gamma.db.base import Base
from bentoml.gamma.db.stores.deployment import DeploymentStore
from bentoml.gamma.db.stores.label import LabelStore
from bentoml.gamma.db.stores.metadata import MetadataStore
...
class DB(object):
    def __init__(self, db_url):
        ...
        if is_sqlite_db(db_url):
            ...
            extra_db_args['connect_args'] = {'application_name': 'gamma'}
